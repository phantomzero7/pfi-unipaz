  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 rounded-3xl bg-slate-900/60 backdrop-blur-xl border border-white/10 p-6 sm:p-8 shadow-2xl space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-slate-950 border border-white/15 rounded-2xl px-4 py-3 text-sm text-white focus:outline-none focus:border-unipaz-orange font-semibold"
            >
              {events.map((evt) => (
          ...
          <div className="grid grid-cols-2 gap-3 p-1.5 rounded-2xl bg-slate-950 border border-white/10">
            <button
            ...
            <button
              ...
              className={`flex items-center justify-center gap-2 py-3 rounded-xl text-xs font-black transition-all ${
                mode === 'check_out'
                  ? 'bg-unipaz-orange text-slate-950 shadow-lg shadow-orange-500/25'
                  : 'text-slate-400 hover:text-white'
              }`}
            >
          ...
          {scanResult && (
            ...
            >
              ...
              <div>
                ...
                {scanResult.details && (
                  <p className="text-xs font-semibold mt-1 text-white bg-slate-950/50 px-2.5 py-1 rounded-md inline-block">
                    {scanResult.details}
                  </p>
                )}
              </div>
          ...
          {useCamera ? (
            <div className="bg-slate-950 p-4 rounded-2xl border border-white/10 flex flex-col items-center">
              ...
              <button
                ...
                className="mt-3 text-xs text-slate-400 hover:text-white font-semibold"
              >
                Desactivar Cámara
              </button>
            </div>
            ...
            <button
              ...
              className="w-full py-4 px-6 rounded-2xl bg-gradient-to-r from-unipaz-cobalt to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-extrabold text-sm flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 transition-all hover:scale-[1.02]"
            >
          ...
          {/* Entrada Manual */}
          <form onSubmit={handleManualSubmit} className="space-y-2 pt-2 border-t border-white/10">
            ...
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                className="px-5 py-2.5 bg-unipaz-orange hover:bg-orange-600 text-slate-950 font-black text-xs rounded-xl shadow-md transition-all"
              >
                Procesar
              </button>
            </div>
              ...
              {profiles
                ...
                .map((std) => (
                  <button
                    ...
                    className="p-3 rounded-2xl bg-slate-950/70 hover:bg-slate-800 border border-white/10 hover:border-unipaz-orange/40 text-left transition-all group"
                  >
                    <div className="text-xs font-bold text-white group-hover:text-unipaz-orange truncate">
        ...
        <div className="lg:col-span-5 rounded-3xl bg-slate-900/60 backdrop-blur-xl border border-white/10 p-6 sm:p-8 shadow-xl space-y-4">
          ...
          {eventAttendances.length === 0 ? (
            ...
            <div className="space-y-2 max-h-[450px] overflow-y-auto pr-1">
              {eventAttendances.map((att) => (
                <div
                  key={att.id}
                  className="p-3 rounded-2xl bg-slate-950/70 border border-white/10 flex items-center justify-between text-xs"
                >
                  <div>
                    ...
                    {att.notes && (
                      <div className="text-[10px] text-amber-300/80 mt-0.5 truncate max-w-[200px]">
                        {att.notes}
                      </div>
                    )}
                  </div>
