...
export default function HomePage() {
  ...
  return (
    <div className="space-y-12 py-4 sm:py-8">
      {/* Hero Section */}
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-unipaz-navy-deep via-unipaz-navy to-slate-950 border border-white/15 p-8 sm:p-12 shadow-2xl">
        <div className="absolute top-0 right-0 w-96 h-96 bg-unipaz-orange/15 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-unipaz-cobalt/25 rounded-full blur-3xl pointer-events-none" />

        <div className="relative z-10 max-w-3xl space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-unipaz-orange/20 border border-unipaz-orange/30 text-amber-300 text-xs font-bold shadow-md">
            <Sparkles className="w-4 h-4 text-unipaz-orange" />
            Sistema Oficial UNIPAZ · Ciclo 2026
          </div>
          ...
          <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
            Plataforma universitaria para la gestión de créditos, registro de actividades extracurriculares, Plan de Vida y Carrera (PVC), validación QR de asistencias y emisión digital de constancias de titulación.
          </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* No Satisfactorio */}
        <div className="rounded-3xl bg-slate-900/60 backdrop-blur-xl border border-rose-500/30 p-6 shadow-xl space-y-3">
          <div className="flex items-center justify-between">
            <span className="px-3 py-1 rounded-full bg-rose-500/20 text-rose-300 text-xs font-bold border border-rose-500/30">
              ≤ 399 Horas
            </span>
            <span className="text-xs text-rose-400 font-semibold">En Proceso</span>
          </div>
          <h3 className="text-lg font-bold text-white">No Satisfactorio</h3>
        ...
        <div className="rounded-3xl bg-slate-900/60 backdrop-blur-xl border border-emerald-500/40 p-6 shadow-xl space-y-3 relative overflow-hidden">
          ...
          <h3 className="text-lg font-bold text-white">Espíritu Unipaceño</h3>
        ...
        {/* Sobresaliente */}
        <div className="rounded-3xl bg-slate-900/60 backdrop-blur-xl border border-amber-400/40 p-6 shadow-xl space-y-3 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-amber-300 font-bold flex items-center gap-1">
              <Sparkles className="w-3.5 h-3.5 text-amber-400" /> Mención Honorífica
            </span>
          </div>
          <h3 className="text-lg font-bold text-white">Nivel Sobresaliente</h3>
          <p className="text-xs text-slate-300 leading-relaxed">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-6 rounded-3xl bg-slate-900/60 border border-white/10 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-unipaz-orange/20 text-unipaz-orange flex items-center justify-center font-bold">
              <QrCode className="w-5 h-5" />
            </div>
            <h4 className="font-bold text-white text-base">Credencial Digital QR</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-slate-900/60 border border-white/10 space-y-3">
            ...
            <h4 className="font-bold text-white text-base">Regla del 80% de Permanencia</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-slate-900/60 border border-white/10 space-y-3">
            ...
            <h4 className="font-bold text-white text-base">Plan de Vida y Carrera (PVC)</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-slate-900/60 border border-white/10 space-y-3">
            ...
            <h4 className="font-bold text-white text-base">Constancias Oficiales PDF</h4>
            <p className="text-xs text-slate-400 leading-relaxed">
      ...
      <section className="rounded-3xl bg-slate-950 border border-white/15 p-6 sm:p-8 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-white/10 pb-4">
          ...
          <span className="text-xs font-semibold px-3 py-1 rounded-full bg-slate-800 text-amber-300 border border-white/10 self-start sm:self-auto">
            ...
            return (
              <button
                ...
                className={`p-4 rounded-2xl border text-left transition-all flex items-center gap-3 ${
                  isCurrent
                    ? 'bg-unipaz-navy border-unipaz-orange shadow-lg shadow-orange-500/10'
                    : 'bg-slate-900/70 border-white/10 hover:border-white/25'
                }`}
              >
                <div className="relative w-11 h-11 rounded-xl overflow-hidden border border-white/20 flex-shrink-0">
                  <Image
                ...
                <div className="truncate flex-1">
                  ...
                  <div className="text-[11px] text-slate-400 mt-0.5">
                    {p.matricula} · <span className="capitalize font-bold text-slate-300">{p.role}</span>
                  </div>
                </div>
              </button>
            );
